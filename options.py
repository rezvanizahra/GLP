...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='caltech101', help='folder | caltech101 | navon ')
        self.parser.add_argument('--dataroot', default='data/caltech101', help='path to dataset')        
        ...
        self.parser.add_argument('--model', type=str, default='resnet18', help='chooses which model to use. resnet18 | gas | inception_v3 | GA-Resnet | GA_Inception')
        self.parser.add_argument('--verbose', action='store_true', help='Print the training and model details.')
        self.parser.add_argument('--add_smartfilter', action='store_true', help='add_gussianblur to the transforms or not.')
        ...
        self.parser.add_argument('--step_size', type=int, default='100', help='number of stepsize to lr decay')
        ...
        #two_stream model
        self.parser.add_argument('--gas_path', type=str, default='', help='path to trained glp model for loading in glp network')
        self.parser.add_argument('--checkpoint_path', type=str, default='', help='path to trained pretrained models for loading test or test on attacks')
        self.parser.add_argument('--repeat_on_attacks', type=int, default=5, help='number of repeatition of attacks')
        self.parser.add_argument('--attack_method', type=str, default='FGSM', help='attack: FGSM | PGD')
